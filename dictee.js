/* =====================================================================
 * dictee.js - CDL Dictee, self-mounting embeddable widget.
 * Mounts into <div id="cdl-dictee"></div>. Needs cdl-tools.js site-wide.
 * Generated from dictee_widget.html - do not hand-edit; rebuild instead.
 * ===================================================================== */
(function(){"use strict";
  if(window.__cdlDicteeMounted)return;window.__cdlDicteeMounted=true;
  ...
  var mount=document.getElementById('cdl-dictee');
  if(!mount){mount=document.createElement('div');mount.id='cdl-dictee';document.body.appendChild(mount);}
  ...
  /* ---- game logic (from dictee_widget.html lines 709-1105) ---- */
    (function () {
            ...
            if (phraseIndex < phrases.length - 1) {
                ...
                if (!CDLTools.hasSubmitted()) {
                    ...
                    showGradeThenForm(completedLevel, lc, function () {
                        CDLTools.openModal({ toolId: 'dictee', trigger: 'win', segment: completedLevel, level: completedLevel, score: lc, title: 'Vous avez obtenu ' + lc + ' sur 10 au niveau ' + completedLevel + '.', dismissLabel: isWinEnd ? 'Non merci, rejouer' : 'Non merci, continuer', successLabel: isWinEnd ? 'Rejouer' : 'Continuer' });
                    });
                } else {
